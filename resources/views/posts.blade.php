...
<x-layout>
  ...
  <div class="py-4 px-4 mx-auto max-w-screen-xllg:px-6">
            ...
            @endif
              <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div class="relative w-full">
                      ...
                      <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search for artikel" type="search" id="search" name="search" autocomplete="off">
                  </div>
                  <div>
  ...
  <div>
    ...
    <a href="/posts" class="text-blue-800">&laquo; Back to all Post</a>
  </div>
